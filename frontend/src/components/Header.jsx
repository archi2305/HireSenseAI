          ...
          <AnimatePresence>
            {bellOpen && (
              <motion.div 
                ...
                className="fixed top-20 right-6 w-full max-w-[320px] z-[90] bg-theme-surface/95 backdrop-blur-2xl border border-theme-border rounded-xl shadow-premium overflow-hidden"
              >
