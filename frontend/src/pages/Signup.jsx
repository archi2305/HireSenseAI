...
function Signup() {
  ...
  const handleGithubSignup = () => {
    if (!oauthEnabled) {
      toast("Social signup is temporarily disabled. Create an account with email.", {
        icon: "ℹ️",
      });
      return;
    }
        ...
        <div className="w-full max-w-[440px] relative z-10 flex flex-col items-center my-8">
          ...
          <div className="w-full linear-card p-10 backdrop-premium border-theme-accent/10 relative overflow-hidden">
            ...
            <div className="mb-8 relative z-10">
              ...
              />
              {!oauthEnabled && (
                <p className="mt-2 text-center text-xs text-theme-textSecondary">
                  Social signup is disabled right now. Use email signup below.
                </p>
              )}
            </div>
