        ...
        <div className="w-full max-w-[440px] relative z-10 flex flex-col items-center my-8">
          ...
          <div className="w-full linear-card p-10 backdrop-premium border-theme-accent/10 relative overflow-hidden">
            ...
            <div className="mb-8 relative z-10">
              <SocialButton icon={GithubIcon} text="GitHub" provider="GitHub" onClick={handleGithubSignup} disabled={loading} className="!bg-theme-bg !border-theme-border hover:!border-theme-accent/30 !text-theme-text" />
            </div>
